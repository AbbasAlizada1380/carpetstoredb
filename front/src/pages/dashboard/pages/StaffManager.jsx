...
import { FaEdit, FaTrash, FaSpinner, FaUsers, FaCalendarAlt } from "react-icons/fa";
import { useSelector } from "react-redux";
import SalaryManagement from "./SalaryManagement"; // adjust import path as needed
...
const StaffManager = () => {
  ...
  if (tableLoading && staffs.length === 0 && activeTab === "staff") {
    return (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-6 space-y-8">
      ...
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">مدیریت کارمندان و حضور و غیاب</h1>
        <p className="text-gray-600">مدیریت اطلاعات کارمندان و ثبت حضور و غیاب</p>
      </div>
                  ...
                  <tbody>
                    {staffs.length === 0 ? (
                      ...
                      staffs.map((staff, index) => (
                        <tr key={staff.id} className="hover:bg-gray-50 border-b last:border-0 transition-colors">
